...
export default function BotaoAlternarTema(props: BotaoAlternarTemaProps) {
  return props.tema === "dark" ? (
    <div
      ...
      className={`bg-gradient-to-r from-yellow-300 to-yellow-600 w-14 lg:w-24 h-8 hidden sm:flex items-center cursor-pointer rounded-full p-1`}
    >
    ...
    <div
      onClick={props.alternarTema}
      className={`bg-gradient-to-r from-gray-500 to-gray-900 w-14 lg:w-24 h-8 hidden sm:flex items-center justify-end cursor-pointer rounded-full p-1`}
    >
